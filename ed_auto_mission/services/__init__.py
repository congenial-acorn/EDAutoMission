...
if TYPE_CHECKING:
    ...
    from ed_auto_mission.services.discord import DiscordWebhookHandler, setup_discord_logging
...
def __getattr__(name: str):
    ...
    if name in ("DiscordWebhookHandler", "setup_discord_logging"):
        from ed_auto_mission.services.discord import DiscordWebhookHandler, setup_discord_logging
        return DiscordWebhookHandler if name == "DiscordWebhookHandler" else setup_discord_logging
